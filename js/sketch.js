...
function draw() {
    ...
    if (ridePlay == true) {
        ...
        //RideEllipse
        fill(col + 10);
        ellipse(width/1.1, height/5, vol + 30)
    }
    
    
    
    //Snare Text
    text("Left Arrow", width/5, height/1.8);
    textSize(32);

    //Tom 1 Text
    text("Up Arrow", width/3, height/4);
    textSize(32);

    //Tom 2 Text
    text("Right Arrow", width/1.7, height/4);
    textSize(32);

    //Tom 3 Text
    text("Down Arrow", width/1.45, height/1.8);
    textSize(32);

    //Hi-Hat Text
    text("Shift", width/30, height/2);
    textSize(32);

    //Kick Text
    text("Space", width/2.15, height/1.2);
    textSize(32);

    //Crash Text
    text("Enter", width/30, height/10);
    textSize(32);

    //Ride Text
    text("Delete", width/1.15, height/5);
    textSize(32);
